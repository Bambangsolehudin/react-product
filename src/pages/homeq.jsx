...
function Home() {
  ...
  // Function
  const getDataCategory = async(token) => {
    try {
     const cat = await  axios.get(`${baseApi}/category`, {
            headers: {
  ...
  useEffect(() => {
    ...
    if(!userRedux) {
      ...
      getDataCategory(token)
    }

    
    // dispatch(cartSliceAction.addToCart({id:3, qty: 40}))
    // let dataDummy = JSON.parse(localStorage.getItem("authData"))
    // if(dataDummy) {
    //   setUsers(dataDummy.data_user)
    //   getDataCategory(dataDummy.access_token)
    // }else {
    //   navigate('/login')
    // }
  }, []);
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="template-admin/img/undraw_profile_1.svg"
                                            alt="..."/>
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="template-admin/img/undraw_profile_2.svg"
                                            alt="..."/>
                                ...
                                <a className="dropdown-item d-flex align-items-center" href="#">
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src="tempate-admin/img/undraw_profile_3.svg"
                                            alt="..." />
